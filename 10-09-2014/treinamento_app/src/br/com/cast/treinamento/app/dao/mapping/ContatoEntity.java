...
public final class ContatoEntity {
    ...
    public static final String[] COLUNAS = { COLUNA_ID, COLUNA_NOME, COLUNA_ENDERECO, COLUNA_SITE, COLUNA_TELEFONE, COLUNA_RELEVANCIA, COLUNA_FOTO };
	...
	public static Contato bindContato(Cursor cursor) {
		if (!cursor.isBeforeFirst() || cursor.moveToNext()) {
			...
			if (!cursor.isNull(cursor.getColumnIndex(COLUNA_FOTO))) {
